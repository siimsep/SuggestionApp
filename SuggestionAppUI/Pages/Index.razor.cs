...
namespace SuggestionAppUI.Pages
{
    public partial class Index
    {
        ...
        private void LoadCreatePage()
        {
            ...
            {
                navManager.NavigateTo("/MicrosoftIdentity/Account/Sigin", true);
            }
        }
        ...
        private async Task FilterSuggestions()
        {
            ...
            suggestions = output; //a filtered list
        ...
        private async Task VoteUp(SuggestionModel suggestion)
        {
            if (loggedInUser is not null)
            {
                ...
                {
                    // cant vote on own suggestion
                    return;
                }

                // check if user is in hashlist of votes
